...
-- Started on 2018-09-25 20:59:46
...
14	cerâmica	laranja	14	01_ce.png	Cerâmica	Esta placa laranja faz parte de um conjunto de xícara e pires de Fiestaware, dos EUA. O óxido de urânio foi usado no esmalte, o que torna essas peças radioativas. Fiesta foi o primeiro dinnerware de cor sólida amplamente comercializado em massa e tornou-se extremamente popular devido às suas cores brilhantes, construção durável e desenhos art déco estilizados. Após sua introdução em 1936, foi uma moda nos EUA por mais de 10 anos, tornando-se um símbolo de status. Durante a Segunda Guerra Mundial, o governo dos EUA assumiu o controle do urânio no país e confiscou os estoques de todas as empresas que o usavam. Hoje em dia, o governo informa que essas peças não são usadas, no entanto, ainda são itens de colecionadores muito populares.
...
25	metal	castanho	25	011_me.png	Metal	Muitas vezes é necessário unir dois metais - como quando se constroem alguns dos imensos edifícios que dominam os horizontes das cidades modernas, ou os imensos navios que passam meses no mar de cada vez, transportando mercadorias por todo o planeta. A economia da indústria automobilística é altamente dependente de robôs de soldagem, e as indústrias de trilhos e dutos são igualmente dependentes dessa técnica. É também uma técnica popular nas artes para escultura. A soldagem é a técnica preferida para unir metais, que exigem uma ligação de alta resistência entre duas partes principais e que deve durar indefinidamente. A soldagem não é um processo trivial, no entanto; exige que ambas as partes sejam fundidas juntas para criar uma junção permanente entre elas, e que não deve ser significativamente mais fraca do que os materiais que ela está unindo. Olhando para esta seção em particular, a junta de solda pode ser vista onde a interface de cada seção de aço foi colocada em contato e então fundida por meio de uma tocha de soldagem, aquecendo o aço acima de 1400 ° C.
...
15	cerâmica	branco	15	02_ce.png	Cerâmica	Esta amostra retangular de cerâmica branca dura parece com plástico, mas seu peso e o som de vidro que faz quando duas peças são unidas, doar que não é. No entanto, esta não é a sua cerâmica comum, tipo xícara de porcelana. Uma das características distintivas da cerâmica tradicional é que ela não pode ser trabalhada ou moldada depois de ser queimada, mas este material pode ser usinado com ferramentas comuns de corte de metal. O tipo de cerâmica que você teria em sua cozinha é obviamente muito frágil - imagine tentar cortar isso com uma serra elétrica! Este material é uma vitrocerâmica especial projetada, produzida em dois estágios pelo primeiro vidro fundido, e então aquecendo esse vidro com aditivos que controlam a maneira como ele cristaliza. Isso faz com que tenha algumas das propriedades de uma cerâmica e algumas de um vidro. Embora possa parecer contra-intuitivo, essa combinação de materiais torna o material final muito mais difícil e mais resistente do que um vidro ou cerâmica padrão, além de produzir propriedades interessantes, como a biocompatibilidade (a cerâmica de vidro pode ser usada como andaime para engenharia de tecidos ). Como a vitrocerâmica pode resistir a temperaturas muito altas e é resistente a ataques químicos, esse material pode ser usado para fazer peças muito difíceis para tarefas que metais e polímeros não podem gerenciar.
...
0	Os materiais podem estar associados a uma categoria?	1	forum2
...
1	Sara	sara@gmail.com	12/02/1998	IMG_0039.JPG	sarab	sara
\.
...
-- Completed on 2018-09-25 20:59:46
